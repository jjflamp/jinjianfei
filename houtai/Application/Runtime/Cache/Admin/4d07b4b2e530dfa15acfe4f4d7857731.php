        ...
        <div class="page-content">
            ...
            <form class="navbar-form form-inline" action="<?php echo U('Admin/index');?>" method="post">
                ...
                <div class="form-group pull-right">
                    <a href="javascript:history.go('-1')" class="btn btn-primary pull-right"><i class="icon-reply"></i>返回上一级</a>
                </div>
            </form>
            <!--</div>-->
                                                ...
                                                <div class="operat hidden1 ">
                                                    ...
                                                    <div class="menu_select   ">
                                                        <ul id="<?php echo ($vo["id"]); ?>">
                                                                <li>
                                                                    <a class="icon-reply set-status" attr-id="<?php echo ($vo["id"]); ?>" attr-message="恢复会员" attr-status="1" href="javascript:void(0)"> 恢复</a>
                                                                </li>
                                                                <!--<li><a class="icon-trash set-status" attr-id="<?php echo ($vo["id"]); ?>" attr-message="删除" attr-status="-1"> 删除</a></li>-->
