                            ...
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td style="width:70px" >
                                                <div class="operat hidden1 ">
                                                    <a  class="icon-cog action" href="javascript:;"> 处理</a>
                                                    <div class="menu_select   ">
                                                        <ul id="<?php echo ($vo["id"]); ?>">
                                                            <?php if(($vo["role"] != '超级管理员') and ($vo["id"] != session('adminUser').id)): ?><!--<li><a class="icon-sitemap" href=""> 授权</a></li>-->
                                                                <li>
                                                                    <?php if($vo["status"] == 1): ?><a class="icon-lock set-status" attr-id="<?php echo ($vo["id"]); ?>" attr-message="冻结" attr-status="0" href="javascript:void(0)"> 冻结</a>
                                                                        <?php else: ?><a class="icon-unlock set-status" attr-id="<?php echo ($vo["id"]); ?>" attr-message="启用" attr-status="1" href="javascript:void(0)"> 启用</a><?php endif; ?>
                                                                </li>
                                                                <li><a class="icon-trash set-status" attr-id="<?php echo ($vo["id"]); ?>" attr-message="删除" attr-status="-1"> 删除</a></li><?php endif; ?>
                                                            <li><a class="icon-pencil" href="/index.php/Admin/User/edit?id=<?php echo ($vo["id"]); ?>"> 编辑</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><?php echo ((isset($arr[$vo['uid']]) && ($arr[$vo['uid']] !== ""))?($arr[$vo['uid']]):'顶级'); ?></td>
                                            <td><a class="icon-zoom-in  " href="/index.php/Admin/User/look?id=<?php echo ($vo["id"]); ?>">查看</a></td>
                                            <td><?php echo ($vo['total']); ?></td>
                                            <td>
                                                <?php if($vo["status"] == 0): ?><i style="color:darkred">冻结</i><?php else: ?><i style="color:green;">启用</i><?php endif; ?>
                                            </td>
