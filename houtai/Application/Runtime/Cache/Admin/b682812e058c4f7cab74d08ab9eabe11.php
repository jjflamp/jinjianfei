...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="/Public/admin/xiaoli/font_icon.css" media="screen">-->
...
<div class="main-container" id="main-container">
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody >
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr info="<?php echo ($vo['id']); ?>">
                                            <td style="width:70px" >
                                                <div class="operat hidden1 ">
                                                    ...
                                                    <div class="menu_select   ">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <?php if($vo["status"] == 1): ?><a class="icon-lock admin-lock" info="1" href="javascript:void(0)"> 锁定</a>
                                                                    <?php else: ?><a class="icon-unlock admin-lock" info="1" href="javascript:void(0)"> 解锁</a><?php endif; ?>
                                                            </li>
                                                            <li><a class="icon-trash" href="" > 删除</a></li><?php endif; ?>
                                                            <li><a class="icon-pencil" href=""> 编辑</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <?php if($vo["status"] == 0): ?><i style="color:darkred">禁用</i><?php else: ?><i style="color:green;">启用</i><?php endif; ?>
                                            </td>
    ...
    <script>
        var SCOPE={
            'save_url' : "/index.php/Admin/Admin/lock",
